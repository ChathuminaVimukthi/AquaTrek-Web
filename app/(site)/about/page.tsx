...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Learn about AquaTrek Hikkaduwa, a family-owned kayaking tour business in Rathgama Lake, Sri Lanka.',
          ...
          <div className="order-1 md:order-2 px-8 md:px-16 py-12 md:py-16 flex flex-col justify-center text-left">
            ...
            <div className="space-y-6 text-gray-700" style={{ fontFamily: '"Asap", Sans-serif' }}>
              ...
              <p className="text-md leading-relaxed text-left">
                ...
                you a real taste of local life. Our routes and experiences are shaped by years of growing up
                around these waters, knowing their hidden corners, the wildlife rhythms, and the best times to
                paddle through calm reflections and golden sunsets.
              </p>

              <p className="text-md leading-relaxed text-left">
                When you visit us, you&apos;re not just joining a tour — you&apos;re being welcomed by a family
                that truly loves what we do, and wants to share that joy with you.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="px-8 md:px-16 py-12 md:py-16 flex flex-col justify-center text-left">
            ...
            <div className="space-y-6 text-white" style={{ fontFamily: '"Asap", Sans-serif' }}>
              <p className="text-md leading-relaxed text-left">
                ...
                Aqua Trek, we don&apos;t rush the journey — we embrace it. Our tours are designed to help you
