    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <div className="w-full py-6 md:py-10">
        <div className="max-w-5xl mx-auto px-8 text-center">
          <h2 
            className="text-xl md:text-2xl text-brand-navy mb-6"
            style={{ fontFamily: '"Gilroy", Sans-serif' }}
          >
            Start Your Kayak Adventure
          </h2>
          <p 
            className="text-2xl md:text-5xl text-brand-navy font-bold leading-relaxed mb-8"
            style={{ fontFamily: '"Gilroy", Sans-serif' }}
          >
            Ready to explore Rathgama Lake? Contact us and we'll take care of the rest.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
            <a 
              ...
              className="bg-secondary hover:bg-secondary-hover text-white px-8 py-4 font-semibold transition-colors duration-300 flex items-center gap-3 min-w-[200px] justify-center"
            ...
            <a 
              href="tel:+1234567890"
              className="bg-brand-navy hover:bg-primary text-white px-8 py-4 font-semibold transition-colors duration-300 flex items-center gap-3 min-w-[200px] justify-center"
              style={{ fontFamily: '"Asap", Sans-serif' }}
            >
