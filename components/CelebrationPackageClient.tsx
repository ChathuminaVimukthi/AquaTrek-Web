  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="w-full h-screen relative">
        <Image src={celebration.heroImage} alt={celebration.title} fill className="object-cover" priority />
      ...
      <div className="w-full relative py-20 md:py-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image src={celebration.tourInfoBg} alt="Celebration Info Background" fill className="object-cover" />
