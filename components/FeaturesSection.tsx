      ...
      <div className="w-full px-4 pt-16 pb-5 md:pt-20 md:pb-5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-4 text-brand-deep leading-relaxed" style={{ fontFamily: '"Asap", Sans-serif' }}>
            ...
            <p className="text-md md:text-md">
              &ldquo;Water Adventures Like No Other&rdquo; - Dive into experiences that go beyond expectations. Because <span className="font-bold">we&apos;re passionate about what we do!</span>
            </p>
          </div>
        </div>
      </div>
