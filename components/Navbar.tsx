...
export default function Navbar() {
  ...
  const handlePhoneClick = () => {
    window.location.href = 'tel:+94773366171'
  }
    ...
    <nav className="sticky top-0 z-50 backdrop-blur-md" style={{ backgroundColor: 'rgba(255, 255, 255, 0.65)', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"' }}>
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center" style={{ height: '48px' }}>
          {/* Logo and Name */}
          <Link href="/" className="flex items-center space-x-3 cursor-pointer" onClick={() => setIsMenuOpen(false)}>
            <Image
              src="/logo-final.JPG"
              alt="AquaTrek Logo"
              width={32}
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <div className="flex items-center space-x-6 px-6">
              <Link href="/about" className="text-brand-navy hover:text-primary transition-colors uppercase" style={{ fontSize: '13px', fontWeight: 600 }}>
                About Us
              </Link>
              <Link href="/vision" className="text-brand-navy hover:text-primary transition-colors uppercase" style={{ fontSize: '13px', fontWeight: 600 }}>
                Our Vision
              </Link>
              <Link href="/blog" className="text-brand-navy hover:text-primary transition-colors uppercase" style={{ fontSize: '13px', fontWeight: 600 }}>
                Blog
              </Link>
            </div>
            ...
            {/* Contact Us Button */}
            <Link href="/contact" className="px-4 text-brand-navy border border-brand-navy rounded-lg hover:bg-primary hover:text-white hover:border-primary transition-colors uppercase" style={{ fontSize: '12px', padding: '6px 20px', fontWeight: 600 }}>
              Contact Us
            </Link>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-4 pt-2 pb-4 space-y-3">
            ...
            {/* Contact Us Button */}
            <Link href="/contact" onClick={toggleMenu} className="block w-full text-center text-brand-navy border border-brand-navy rounded-lg hover:bg-primary hover:text-white hover:border-primary transition-colors uppercase" style={{ fontSize: '12px', padding: '8px 24px', fontWeight: 600 }}>
              Contact Us
            </Link>
          </div>
        </div>
